<template>
  <div class="lf-page-container attendance-container">
    ...
    <div class="lf-page-header bordered">
      <span class="lf-page-caption pin">查询日期{{ daysQueried }}天；共{{  }}条查询记录。</span>
    ...
    <el-table class="custom-table mt15"
      ...
      <el-table-column label="员工" property="normal"></el-table-column>
      <el-table-column label="部门" property="latecomer"></el-table-column>
      <el-table-column label="职务" property="absence"></el-table-column>
      <el-table-column label="一脸照片" property="leave"></el-table-column>
    </el-table>
